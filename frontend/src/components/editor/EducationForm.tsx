      ...
      <CardContent className="p-3 space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div className="space-y-1">
            <Label
              htmlFor={`edu-institution-${education.id}`}
          ...
          <div className="space-y-1">
            <Label
              htmlFor={`edu-degree-${education.id}`}
              className="text-xs sm:text-xs"
            >
              Degree *
            </Label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                updateEducation(education.id, "specialization", e.target.value)
              }
              placeholder="AI/ML"
              className="h-10 text-base sm:h-8 sm:text-sm"
            />
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                updateEducation(education.id, "cgpa", e.target.value)
              }
              placeholder="3.9/4.0"
              className="h-10 text-base sm:h-8 sm:text-sm"
            />
          ...
          <div className="space-y-1">
            <Label className="text-xs sm:text-xs">Dates</Label>
            <div className="flex gap-1">
              <div className="flex-1">
                <Label
                  htmlFor={`edu-start-${education.id}`}
                  className="sr-only"
                >
                  Start date
                </Label>
                <MonthPicker
                  ...
                  onValueChange={(val) =>
                    updateEducation(education.id, "startDate", val)
                  }
              ...
              <div className="flex-1">
                <Label htmlFor={`edu-end-${education.id}`} className="sr-only">
                  End date
                </Label>
                <MonthPicker
                  ...
                  onValueChange={(val) =>
                    updateEducation(education.id, "endDate", val)
                  }
                  aria-label="End date"
                  className="h-10 text-base sm:h-8 sm:text-sm"
                />
