    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <div className="space-y-1">
          <Label htmlFor={`edu-institution-${education.id}`} className="text-xs sm:text-[10px]">Institution *</Label>
          <Input
        ...
        <div className="space-y-1">
          <Label htmlFor={`edu-degree-${education.id}`} className="text-xs sm:text-[10px]">Degree *</Label>
          <Input
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
        <div className="space-y-1">
          <Label htmlFor={`edu-spec-${education.id}`} className="text-xs sm:text-[10px]">Specialization</Label>
          <Input
        ...
        <div className="space-y-1">
          <Label htmlFor={`edu-cgpa-${education.id}`} className="text-xs sm:text-[10px]">CGPA</Label>
          <Input
        ...
        <div className="space-y-1">
          <Label className="text-xs sm:text-[10px]">Dates</Label>
